...
public class StringUtils {
	 ...
	 * @return Each of the strings in the given array delimited by the given string.
	 */
	 ...
	 * @param delim
	 *            The delimiter.
	 * @return The last part of the string after the last instance of the delimiter,
	 *         or the original string if the delimiter is not present.
	 */
	 ...
	 *
	 * Convert to lower case, and remove underscores uppercasing the next letter.
	 *
	 * @param value
	 *            The enum value.
	...
	/**
	 * Find a breaking point in a line between two words. The breaking point is as
