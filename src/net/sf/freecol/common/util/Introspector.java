...
public class Introspector {
	...
	/**
	 * Get a function that converts to String from a given class. We use Enum.name()
	 * for enums, and String.valueOf(argType) for the rest.
	 *
	 * @param argType
	 ...
	 * Enum.valueOf(Class, String) for enums, and argType.valueOf(String) for the
	 * rest, having first dodged the primitive types.
	 *
	 * @param argType
	 *            A <code>Class</code> to find a converter for.
	 * @return A conversion function, or null on error.
	 ...
	 *
	 * @param obj
	 *            An <code>Object</code> (really of type theClass) whose get-method
	 *            is to be invoked.
	 ...
	 *
	 * @param obj
	 *            An <code>Object</code> (really of type theClass) whose set-method
	 *            is to be invoked.
	 * @param value
