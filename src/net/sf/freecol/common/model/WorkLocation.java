...
public abstract class WorkLocation extends UnitLocation implements Ownable {
	...
	public static class Suggestion {
		...
		/**
		 * Suggest that work done by (optional) <code>oldType</code> would be better
		 * done by <code>newType</code> because it could produce <code>amount</code>
		 * more <code>goodsType</code>.
		 *
		 * @param workLocation
		 *            The <code>WorkLocation</code> to add a unit to.
		 * @param oldType
		 *            The optional <code>UnitType</code> currently doing the work.
		 * @param newType
	...
	/**
	 * Creates a new <code>WorkLocation</code> with the given identifier. The object
	 ...
	 *
	 * This assumes that all units in a work location are doing the same work, which
	 * is true for now.
	 *
	 * @return The current <code>GoodsType</code> being produced, or null if none.
	 */
	...
	/**
	 * Update production type on the basis of the current work location type (which
	 * might change due to an upgrade) and the work type of units present.
	 */
	 ...
	 * @return The best work <code>GoodsType</code> for the unit, or null if none
	 *         found.
	 */
	 ...
	 *
	 * @param unit
	 *            The <code>Unit</code> that is doing the job at present, which may
	 *            be null if none is at work.
	 * @param productionType
	 *            The <code>ProductionType</code> to use.
	 * @param goodsType
	 *            The <code>GoodsType</code> to produce.
	 * @return A <code>Suggestion</code> for a better worker, or null if improvement
	 *         is not worthwhile.
	 */
	 ...
	 *
	 * @return A mapping of either existing units or null (denoting adding a unit)
	 *         to a <code>Suggestion</code>.
	 */
	 ...
	 * optional unit type to do the production may be specified, however if null the
	 * unattended production will be calculated.
	 *
	 * Usually if a unit type is specified and a unit can not be added to the work
	 * location, zero production is returned. However, this routine is intended to
	 * be used for planning purposes, so some exceptions are allowed --- the
	 * calculation proceeds:
	 *
	 * - for unclaimed tiles - when the location is currently full of units
	 *
	 * which are conditions that an AI might plausibly be able and willing to change
	 * (a case could be made for including the OCCUPIED_BY_ENEMY condition).
	 *
	 * @param goodsType
	 *            The <code>GoodsType</code> to produce.
	 * @param unitType
	 ...
	 * given type in this work location. That is, the production exclusive of any
	 * modifiers. If no unit type is specified, the unattended production is
	 * calculated.
	 *
	 * @param productionType
	...
	/**
	 * Gets the production modifiers for the given type of goods and unit type. If
	 * no unit is specified the unattended production is calculated.
	 *
	 * @param goodsType
	 *            The <code>GoodsType</code> to produce.
	 * @param unitType
	...
	/**
	 * Sets the owner of this <code>Ownable</code>. Do not call this method, ever.
	 * The owner of this WorkLocation is the owner of the Colony, you must set the
	 * owner of the Colony instead.
	 *
	 * @param p
