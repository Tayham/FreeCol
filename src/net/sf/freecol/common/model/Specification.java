...
public final class Specification {
	 ...
	 *
	 * Useful to load the user game and map generator options before starting a new
	 * game.
	 *
	 * @param optionId
	 *            The root identifier of an option group expected to be found in the
	 *            file.
	 * @param file
	 ...
	 *
	 * Useful to save the user game and map generator options before starting a new
	 * game.
	 *
	 * @param group
	 ...
	 *
	 * Builds all the cached containers and secondary variables. This *must* clear
	 * any containers before building as it may be called multiple times in response
	 * to various specification updates.
	 *
	 * @param why
	 ...
	 *
	 * Only call this in the server. If clients call it the European prices can be
	 * desynchronized.
	 */
	...
	/**
	 * Registers an Ability's id as defined. This is useful for abilities that are
	 * required rather than provided by FreeColGameObjectTypes.
	 *
	 * @param id
	 *            The object identifier.
	 */
	 ...
	 * Introduce this routine to collect them into one place, in the hope we can one
	 * day deprecate this routine and clean up the special cases.
	 *
	...
	/**
	 * Get the initial <em>minimum</em> price of the given goods type. The initial
	 * price in a particular Market may be higher.
	 *
	 * @param goodsType
	 ...
	 *
	 * @param player
	 *            The <code>Player</code> to find the default unit type for, or null
	 *            indicating a normal player nation (i.e. non-REF European).
	 ...
	 *
	 * Provides a type to use to make a neutral comparison of the productivity of
	 * work locations.
	 *
	 * @param nationType
	 *            The <code>NationType</code> to find the default unit type for, or
	 *            null indicating a normal player nation (i.e. non-REF European).
	 ...
	 *            roles are used.
	 * @return The first <code>Role</code> found with the required ability, or null
	 *         if none found.
	 */
	...
	/**
	 * Get an equipment type by identifier. Still needed by backward compatibility
	 * code in Unit.readChild.
	 *
	 * @param id
	 *            The object identifier.
	 ...
	 * @param id
	 *            The id to look for.
	 * @return The corresponding difficulty level <code>OptionGroup</code>, if any.
	 */
	 ...
	 * @param abilities
	 *            The abilities for the search
	 * @return A list of <code>FreeColGameObjectType</code>s with at least one of
	 *         the given abilities.
	 */
	 ...
	 *
	 * Deliberately not part of applyFixes(), this is called from readFromXML which
	 * can most accurately determine whether it is needed.
	 */
