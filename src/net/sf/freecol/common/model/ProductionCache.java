...
public class ProductionCache {
	 ...
	 * dependencies. But not yet. This assumption is made explicit by getting the
	 * ProductionInfo from ColonyTiles with the simple getBasicProductionInfo()
	 * routine, but from Buildings with getAdjustedProductionInfo() which takes
	 * account of the input and output goods levels.
	 *
	 * FIXME: Ideally these should be unified into a WorkLocation.getProductionInfo
	...
	/**
	 * Gets the <code>ProductionInfo</code> for the given {@link WorkLocation} or
	 * {@link Consumer}.
	 *
	 * @param object
