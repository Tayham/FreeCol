...
public class ColonyTile extends WorkLocation {
	 ...
	 * confuse this with getTile(), which returns the colony center tile (because
	 * every work location belongs to the enclosing colony).
	 */
	...
	/**
	 * Create a new <code>ColonyTile</code> with the given identifier. The object
	 ...
	 * tiles: - All tile improvements contribute to the production of food - Only
	 * natural tile improvements, such as rivers, contribute to the production of
	 * other types of goods. - Artificial tile improvements, such as plowing, are
	 * ignored.
	 *
