...
public class NationOptions extends FreeColObject {
	...
	/**
	 * Defend against an invalid nation tag. This can happen when using classic mode
	 * (no extra Europeans) but loading a map that contains the extra Europeans.
	 *
	 * @param xr
	 *            The <code>FreeColXMLReader</code> to read from.
