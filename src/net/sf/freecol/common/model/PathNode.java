...
public class PathNode {
	 ...
	 *
	 * @param location
	 *            The <code>Location</code> this <code>PathNode</code> represents in
	 *            the path.
	 * @param movesLeft
	 *            The number of moves remaining at this point in the path.
	 * @param turns
	 *            The number of turns it takes to reach this <code>PathNode</code>'s
	 ...
	 *
	 * @return The <code>Tile</code> this <code>PathNode</code> represents in the
	 *         path, if any.
	 */
	public Tile getTile() {
	...
	/**
	 * Gets the number of turns it will take to reach this <code>PathNode</code>'s
	 * <code>Tile</code> in the path.
	 *
	 * @return The number of turns, using zero for the first move. <code>-1</code>
	...
	/**
	 * Sets the number of turns it will take to reach this <code>PathNode</code>'s
	 * <code>Tile</code> in the path.
	 *
	 * @param turns
	 ...
	 *
	 * @return <code>true</code> if the unit is still onboard a carrier when using
	 *         this path.
	 ...
	 *
	 * @param onCarrier
	 *            Should be set to <code>true</code> in order to indicate that the
	 *            unit using this path is still onboard the carrier on this path
	 *            node.
	 * @see #getTransportDropTurns
	 */
	 ...
	 *         {@link #getTile}, or null if there is no previous node or either this
	...
	/**
	 * Gets the number of turns it takes to reach the {@link #getTransportDropNode
	 * transport node}.
	 *
	 * @return The number of turns in takes to get to the node where the unit using
	 *         this path should leave it's transport.
	 */
	 ...
	 *
	 * Static version provided for path calculation comparisons. Some care is taken
	 * to avoid overflow as test paths with infinite moves are created in the path
	 * planning process.
	 *
	 * @param turns
	 ...
	 *
	 * @return The first node along the path which is a carrier move, or null if the
	 *         path does not use a carrier.
	 */
