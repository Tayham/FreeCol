...
public abstract class Feature extends FreeColObject implements Named {
	 ...
	 * parties, and need to be serialized by the FreeColGameObject they apply to.
	 */
	 ...
	 * @return True if there are no scopes, or at least one scope is applicable to
	 *         the object.
	 */
	 ...
	 * @return True if the Feature has an lastTurn turn smaller than the given turn.
	 */
	 ...
	 * other entity such as a founding father. This is important for player and
	 * colony serialization, where we do *not* want to read or write derived
