...
public class MarketData extends FreeColGameObject {
	...
	/**
	 * Creates a new <code>MarketData</code> with the given identifier. The object
	 ...
	 * initial price and goods-type specific information. Ensures that prices change
	 * incrementally with a clamping mechanism.
	 *
