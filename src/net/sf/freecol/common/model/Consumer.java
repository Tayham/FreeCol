...
public interface Consumer {
	...
	Comparator<Consumer> COMPARATOR = Comparator.comparingInt(Consumer::getPriority).reversed();
	...
	/**
	 * Returns whether the consumer has the ability with the given identifier. The
	 * ability most relevant to consumers is "consumeAllOrNothing", which implies
	 * that the consumer will not consume any goods if its requirements can not be
	 * met and is used by BuildQueues.
	 *
	 * @param id
	 ...
	 * consumers is "consumeOnlySurplusProduction", which implies that the consumer
