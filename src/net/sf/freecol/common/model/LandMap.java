...
public class LandMap {
	...
	/**
	 * Create a new land map using parameters from a supplied map generator options
	 * option group.
	 *
	 * @param mgo
	 ...
	 * factor, whether a given map position should be set to land. This is called
	 * for all valid map positions adjacent to a position that has been set to land
	 * by #setLand(int,int), and may recursively call setLand for the current
	 * position.
	 *
	 * @param x
