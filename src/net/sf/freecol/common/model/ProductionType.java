...
public class ProductionType extends FreeColObject {
	...
	/**
	 * Creates a new production type that consumes no raw materials and produces the
	 * given output.
	 *
	 * @param outputs
	...
	/**
	 * Convenience constructor for a new <code>ProductionType</code> instance with a
	 ...
	 * @return The most productive output that produces the goods type, or null if
	 *         none found.
	 */
