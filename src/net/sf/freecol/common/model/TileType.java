...
public final class TileType extends FreeColGameObjectType {
	...
	/**
	 * Use these tile types only for "land maps", i.e. maps that only distinguish
	 * water and land.
	 */
	...
	/**
	 * The possible production types of this tile type. This includes the production
	 * types available if a tile of this type is a colony center tile.
	 */
