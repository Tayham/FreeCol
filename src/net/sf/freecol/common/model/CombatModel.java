...
public abstract class CombatModel {
	 ...
	 * only, for the purposes of the pre-combat display. In these cases the actual
	 * defender unit is hidden from the attacker player, so the defender is shown as
	...
	/**
	 * Generates a list of results of an attack. The first must be one of NO_RESULT,
	 * LOSE or WIN. The rest can be any other CombatResult suitable to the
	 * situation. To be called by the server only.
	 *
	 * @param random
