...
public abstract class Settlement extends GoodsLocation implements Nameable, Ownable {
	...
	/**
	 * Initiates a new <code>Settlement</code> with the given identifier. The object
	 ...
	 *
	 * We can not clear the settlement owned tiles container when the settlement is
	 * read because this is called when the Tile is read, and tiles can appear
	 * before and after the settlement in the map definition. So we just accumulate
	 * and defend against duplicates.
	 *
	 * @param tile
	...
	/**
	 * Gets whether this settlement is connected to the high seas. This is more than
	 * merely non-landlocked, because the settlement could be on an inland lake.
	 *
	 ...
	 * This is a measure of how close this settlement is to Europe.
	 *
	...
	/**
	 * Determines if this settlement can build the given type of equipment. Unlike
	 * priceGoods, this takes goods "reserved" for other purposes into account (e.g.
	 * breeding).
	 *
	 * @param goods
	...
	/**
	 * Check if colony has the ability to bombard an enemy ship adjacent to it. Only
	 * sea-side colonies can bombard. Does it have the buildings that give such
	 * abilities?
	 *
	 ...
	 *
	 * Allow player == null as this is true in the map editor where the user player
	 * is moot.
	 *
	 * @param player
