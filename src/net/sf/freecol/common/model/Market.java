...
public final class Market extends FreeColGameObject implements Ownable {
	...
	public Market(Game game, Player player) {
		...
		/*
		 * Create the market data containers for each type of goods and seed these
		 * objects with the initial amount of each type of goods.
		 */
	 ...
	 * @param type
	 *            A <code>GoodsType</code> value.
	 * @return The price for a single unit of the given type of goods if it is for
	 *         sale.
	 */
	 ...
	 * during the game, the price change clamping mechanism should remain in effect.
	 *
	 * @param goodsType
	 ...
	 *
	 * @return An array of all the <code>TransactionListener</code>s added, or an
