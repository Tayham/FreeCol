...
public final class BuildingType extends BuildableType {
	...
	/**
	 * The consumption priority of a Building of this type. The higher the priority,
	 * the earlier will the Consumer be allowed to consume the goods it requires.
	 *
	 ...
	 * GameOptions.TILE_PRODUCTION option. Should we implement a corresponding one
	 * for BuildingTypes?
	 *
	 * @param unattended
	 *            Whether the production is unattended.
	 ...
	 * @param unitType
	 *            An optional <code>UnitType</code> that is to do the work, if null
	 *            the unattended production is considered.
