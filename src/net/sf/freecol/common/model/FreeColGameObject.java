...
public abstract class FreeColGameObject extends FreeColObject {
	...
	/**
	 * Creates a new <code>FreeColGameObject</code>. Automatically assign an object
	 * identifier and register this object at the specified <code>Game</code>,
	 * unless this object is a <code>Game</code> in which case it is given an
	 * identifier of zero.
	 *
	 * @param game
	...
	/**
	 * Creates a new <code>FreeColGameObject</code>. If an identifier is supplied,
	 * use that, otherwise leave it undefined.
	 *
	 * This routine should be used when we intend later to call one of: -
	 * {@link #readFromXML(FreeColXMLReader)} - {@link #readFromXMLElement(Element)}
	 *
	 * @param game
	 *            The <code>Game</code> in which this object belongs.
	 * @param id
	 ...
	 * when this object goes away. Arrange that the object itself is last.
	 *
	 ...
	 * from the resulting XML. We need to pass the result class, since the object we
	 * are about to "clone" is likely a server object.
	 *
	 * @param returnClass
	 *            The class to clone.
	 ...
	 * player.
	 *
	 * Objects do not have links by default, hence the null return here. However,
	 * for example, a player's colony should return itself as a link target.
	 *
	 * @param player
	...
	public boolean equals(Object o) {
		...
		if (o instanceof FreeColGameObject) {
			...
			return getGame() == fco.getGame() && super.equals(o);
		}
		return false;
	}
	...
	/**
	 * Gets the tag name of the root element representing this object. This method
	 * should be overwritten by any sub-class, preferably with the name of the class
