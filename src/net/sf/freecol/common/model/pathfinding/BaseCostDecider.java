...
class BaseCostDecider implements CostDecider {
	...
	/**
	 * Gets the number of moves left after the proposed move. This method should be
	...
	/**
	 * Gets the number of turns consumed by the proposed move. This method should be
	 * called after invoking {@link #getCost}.
	 * 
