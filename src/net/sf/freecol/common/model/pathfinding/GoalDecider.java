...
public interface GoalDecider {
	 ...
	 * @param pathNode
	 *            The <code>PathNode</code> where the <code>Tile</code> returned by
	 *            <code>pathNode.getTile()</code> is the tile to be checked.
	 * @return <code>true</code> if the <code>PathNode</code> was either a goal or a
	 *         sub goal and <code>false</code> otherwise. The goal should be
	 *         returned by {@link #getGoal()} right after a call to this method, if
