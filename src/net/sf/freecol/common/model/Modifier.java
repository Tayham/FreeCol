...
public class Modifier extends Feature {
	...
	/**
	 * Creates a new <code>Modifier</code> instance from another with an identifier
	 * override.
	 *
	 * @param id
	 *            The object identifier.
	 ...
	 * specified identifier from a template modifier (containing the increment and
	 * value) and given start turn.
	 *
