...
public class TileItemContainer extends FreeColGameObject {
	 ...
	 * @param tile
	 *            The <code>Tile</code> this <code>TileItemContainer</code> contains
	 ...
	 *
	 * @return A river <code>TileImprovement</code> if any, or null if not found.
	 */
	...
	/**
	 * Try to add a <code>TileItem</code> to this container. If the item is of lower
	 * magnitude than an existing one the existing one stands.
	 *
	 * @param item
	 *            The <code>TileItem</code> to add to this container.
	 * @return The added <code>TileItem</code> or the existing <code>TileItem</code>
	 ...
	 * @return The <code>TileItem</code> that has been removed from this container
	 *         (if any).
	 */
	 ...
	 *
	 * This is not used for normal production, but is necessary to calculate colony
	 * center tile secondary production, which does not profit from artificial
	 * improvements such as plowing. It is also used to assess which goods are
	 * likely to be most productive on a tile.
	 *
	 * @param goodsType
