...
public final class Ability extends Feature {
	...
	/**
	 * The ability of certain buildings (e.g. the stables) to produce goods even if
	 * no units are present.
	 */
	public static final String AUTO_PRODUCTION = "model.ability.autoProduction";

	/**
	 * The ability of certain buildings (e.g. the stables) to avoid producing more
	 * goods than the colony can store, which would normally go to waste.
	 */
	...
	/**
	 * The ability to be born in an IndianSettlement. Only Units with this ability
	 * can be produced by an IndianSettlement.
	 */
	 ...
	 * units. Units lacking this ability (e.g. braves) will be destroyed instead.
	 */
	...
	/**
	 * The ability of certain units (e.g. privateers) to capture goods carried by
	...
	/**
	 * The ability of certain consumers (e.g. BuildQueues) to consume a large amount
	 * of goods at once instead of turn by turn.
	 */
	...
	/**
	 * The somewhat controversial ability of expert units in factory level buildings
	 * to produce a certain amount of goods even when no raw materials are
	 * available. Allegedly, this is a feature of the original game.
	 */
	...
	/**
	 * The ability denoting that this is an independent nation. Note: this differs
	 * from INDEPENDENCE_DECLARED in that the REF is also (representing) an
	 * independent nation.
	 */
	...
	/**
	 * The ability of certain units (e.g. privateers) to attack and plunder another
	 * player's units without causing war.
	 */
