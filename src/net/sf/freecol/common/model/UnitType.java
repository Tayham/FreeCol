...
public final class UnitType extends BuildableType implements Consumer {
	...
	/**
	 * The offence of this UnitType. Only Units with an offence value greater than
	 * zero can attack.
	 */
	...
	/**
	 * The number of hit points this UnitType has. At the moment, this is only used
	 * for ships. All other UnitTypes are downgraded or destroyed if they lose a
	 * battle.
	 */
	 ...
	 * must have a military role. Artillery of all sorts has higher defense so they
	 * are automatically defensive.
	 *
	...
	/**
	 * Get the base price of this unit type. For the actual price of the unit, use
	...
	/**
	 * Sets the list of all type changes associated with this unit type. Public for
	 * the test suite.
	 *
	 * @param typeChanges
	 ...
	 *            attempting to move to a native settlement when the skill taught
	...
	/**
	 * Gets the priority of this Consumer. The higher the priority, the earlier will
	...
	protected void readChild(FreeColXMLReader xr) throws XMLStreamException {
		...
		if (CONSUMES_TAG.equals(tag)) {
			...
			if (xr.getAttribute(DELETE_TAG, false)) {
				...
				UnitTypeChange change = new UnitTypeChange(xr, spec);// Closes tag
