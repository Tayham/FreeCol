...
public class LostCityRumour extends TileItem {
	...
	/**
	 * The type of the rumour. A RumourType, or null if the type has not yet been
	 * determined.
	 */
	private RumourType type = null;

	/**
	 * The name of this rumour, or null, if it has none. Rumours such as the Seven
	 * Cities of Gold and Fountains of Youth may have individual names.
	 */
	 ...
	 *
	 *         FIXME: Make RumourType a FreeColGameObjectType and move all the magic
	 *         numbers in here to the specification.
	 */
