...
public abstract class GoodsLocation extends UnitLocation {
	 ...
	 * @return The goods that was removed, which may be less than that requested, or
	 *         null if none.
	 */
	...
	/**
	 * Gets a list of all the goods in this location. Each list member is limited to
	 * a maximum amount of CARGO_SIZE, thus there may be multiple entries with the
	 * same goods type.
	 *
	 ...
	 * <code>Goods</code> for each <code>GoodsType</code>, thus the amount of goods
	 * may exceed CARGO_SIZE.
	 *
	 * @return A list of goods.
	 */
