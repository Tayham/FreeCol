...
public class Goods extends AbstractGoods implements Locatable, Ownable {
	 ...
	 * we can not use the ship as it is removed/disposed at once while the looting
	 ...
	 * goods is.
	 *
	 * This constructor only asserts that the game and that the location (if given)
	 * can store goods. The goods will not be added to the location (use
