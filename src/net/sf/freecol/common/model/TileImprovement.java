...
public class TileImprovement extends TileItem implements Named {
	...
	/**
	 * Whether this is a virtual improvement granted by some structure on the tile
	 * (a Colony, for example). Virtual improvements will be removed along with the
	 * structure that granted them.
	 */
	 ...
	 *
	 * This constructor asserts that the game, tile and type are valid. Does not set
	 * the style.
	 *
	 * @param game
	...
	/**
	 * Set the virtual status of this improvement. Used for the roads in a colony
	 * center tile.
	 *
	 * @param virtual
	...
	/**
	 * Updates the connections from/to this river improvement on the basis of the
	 * expected encoded river style.
	 *
	 * @param conns
	 ...
	 * @return A string encoding of the correct connections for this improvement.
	 */
