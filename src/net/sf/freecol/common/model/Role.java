...
public class Role extends BuildableType {
	 ...
	 * <code>null</code>. Note that some UnitTypes and Roles may be disposed instead
	 * of downgraded when losing a battle.
	 */
	 ...
	 * The first role may be <code>null</code> implying the default role, the second
	 * must not. Note that excess goods that are left over after the change will
	 * appear on the list with negative amounts.
	 *
	 * @param from
