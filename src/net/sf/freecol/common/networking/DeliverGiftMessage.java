...
public class DeliverGiftMessage extends DOMMessage {
	...
	/**
	 * Get the <code>Settlement</code> which is receiving the gift. This is a helper
	 * routine to be called in-client as it blindly trusts its field.
	 *
	...
	/**
	 * Get the <code>Goods</code> delivered as a gift. This is a helper routine to
	 * be called in-client as it blindly trusts its field.
	 *
