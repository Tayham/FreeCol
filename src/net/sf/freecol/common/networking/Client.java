...
public final class Client {
	...
	/**
	 * The <code>Connection</code> this <code>Client</code> uses when communicating
	 * with the server.
	 */
	 ...
	 * @param message
	 *            The <code>DOMMessage</code> to send.
	 * @return The answer from the server or <code>null</code> if either an error
	 *         occured or the server did not send a reply.
	 * @see #sendAndWait
	 * @see #send
	 * @exception IOException
	 */
