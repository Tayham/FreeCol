...
public class ChangeWorkImprovementTypeMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>ChangeWorkImprovementTypeMessage</code> with the supplied
	 * unit and improvement type.
	 *
	 * @param unit
	...
	/**
	 * Create a new <code>ChangeWorkImprovementTypeMessage</code> from a supplied
	 * element.
	 *
	 * @param game
