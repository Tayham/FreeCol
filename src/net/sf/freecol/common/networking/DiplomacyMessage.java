...
public class DiplomacyMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>DiplomacyMessage</code> from a supplied element. The unit
	 * is supplied in case it was hidden in some way, such as aboard a ship.
	 *
	 * @param game
	 ...
	 * @return An <code>Element</code> describing the trade with either "accept" or
	 *         "reject" status, null on trade failure, or an error
