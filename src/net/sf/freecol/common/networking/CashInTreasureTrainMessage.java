...
public class CashInTreasureTrainMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>CashInTreasureTrainMessage</code> with the supplied name.
	 *
	 * @param unit
	...
	/**
	 * Create a new <code>CashInTreasureTrainMessage</code> from a supplied element.
	 *
	 * @param game
	 ...
	 * @return An update resulting from cashing in the treasure train, or an error
