...
public class ScoutSpeakToChiefMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>ScoutSpeakToChiefMessage</code> with the supplied unit and
	 * direction.
	 *
	 * @param unit
	...
	/**
	 * Create a new <code>ScoutSpeakToChiefMessage</code> from a supplied element.
	 *
	 * @param game
	 ...
	 * @return An element containing the result of the scouting action, or an error
