...
public class SetTradeRoutesMessage extends DOMMessage {
	...
	/**
	 * Creates a trade route from an element. Be careful not to allow real IDs to
	 * surface or the trade route constructor will replace the existing game trade
	 * route with the one in the element before we have finished checking it.
	 *
