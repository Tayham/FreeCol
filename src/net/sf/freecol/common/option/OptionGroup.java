...
public class OptionGroup extends AbstractOption<OptionGroup> {
	 ...
	 *
	 * - Option groups are *not* merged, but their leaf options are. - If an option
	 * is not already present it is ignored. - If an option is present, it is merged
	 * but in the option group where it is already placed.
	 *
	 * The intent is that the option group structure is never subject to merging.
	 *
	 * @param option
