 ...
 * Enable the Debug menu, the extra commands in
				 ...
				 */
		INIT, /**
 * An initial colony is made, and goods added to all
				 * native settlements.
				 */
	 ...
	 *
	 * @return The <code>Player</code> to display colony values for, or null if not
	 *         to display.
	 */
	...
	/**
	 * Emergency run time log to use when the normal logging is failing. It might as
	 * well be here.
	 *
	 * @param msg
	 *            The message to log.
	...
	/**
	 * Miscellaneous debug helper to get a string representation of the current call
	 * stack.
	 *
