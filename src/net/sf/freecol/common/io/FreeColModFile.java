...
public class FreeColModFile extends FreeColDataFile implements ObjectWithId {
	 ...
	 *
	 * @return An <code>InputStream</code> to the file "specification.xml" within
	 *         this data file, or null if none present.
	 * @exception IOException
	 ...
	 *
	 * @return An <code>InputStream</code> to the file "mod.xml" within this data
	 *         file.
	 * @exception IOException
	 *                if thrown while opening the input stream.
	 */
