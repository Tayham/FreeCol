...
public class FreeColSavegameFile extends FreeColDataFile {
	...
	/**
	 * The name of a properties file that contains information about the saved game,
	 * such as the size of the map, the date and time it was started, and so on. The
	 * map size is used in the
	...
	/**
	 * The name of the image file that contains the map thumbnail, i.e. a view of
	 * the game map as seen by the owner of the game when saving. The thumbnail
	 ...
	 *
	 * @return An <code>InputStream</code> to the file "savegame.xml" within this
	 *         data file.
	 * @throws IOException
