...
public class FreeColDataFile {
	...
	/**
	 * A prefix string for the jar-entries (only if {@link #file} is a ZIP-file).
	 */
	 ...
	 *
	 * @param filename
	 *            The filename of a resource within this collection of data. If this
	 *            object represents a directory then the provided filename should be
	 *            relative towards the path of the directory. In case of a
	 *            compressed archive it should be the path within the archive.
	 ...
	 *
	 * @param requiredFile
	 *            If non-null, the filter will accept a directory containing this
	 *            file.
	 * @param endings
