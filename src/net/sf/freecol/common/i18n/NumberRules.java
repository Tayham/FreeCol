...
public class NumberRules {
	...
	/**
	 * A rule that assigns 1 to category "one", 2 to category "two" and all other
	 * numbers to category "other".
	 */
	...
	/**
	 * Creates a new <code>NumberRules</code> instance from the given input stream,
	 * which must contain an XML representation of the CLDR plural rules.
	 *
	 * @param in
	...
	/**
	 * Returns a rule appropriate for the given language, or the OTHER_NUMBER_RULE
