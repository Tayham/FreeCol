...
public class ResourceFactory {
	...
	/**
	 * <code>WeakHashMap</code>s to ensure that only one <code>Resource</code> is
	 * created given the same <code>URI</code>.
	 */
	 ...
	 * @param output
	 *            Where a previously created instance of <code>Resource</code> with
	 *            the given <code>URI</code> is put if such an object has already
	 *            been created.
	...
	/**
	 * Returns an instance of <code>Resource</code> with the given <code>URI</code>
	 * as the parameter.
	 *
	 * @param uri
	 *            The <code>URI</code> used when creating the instance.
