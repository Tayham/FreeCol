...
public abstract class AIPlayer extends AIObject {
	...
	/**
	 * Temporary variable, used to hold all AIUnit objects belonging to this AI. Any
	 * implementation of AIPlayer needs to make sure this list is invalidated as
	 * necessary, using clearAIUnits(), so that getAIUnitIterator() will create a
	 * new list.
	 */
	 ...
	 * @param player
	 *            The <code>ServerPlayer</code> to associate this AI player with.
	 */
	 ...
	 *
	 * @param p
	 *            The new <code>Player</code>. protected void setPlayer(ServerPlayer
	 *            p) { player = p; }
	 */
	 ...
	 *
	 * @return The connection that can be used when communication with the server.
	 */
	...
	/**
	 * Returns an iterator over all the <code>AIUnit</code>s owned by this player.
	 *
	...
	/**
	 * Get a DefendSettlementMission for the current settlement of a unit if it is
	 * badly defended.
	 *
	 * @param aiUnit
	...
	/**
	 * Tells this <code>AIPlayer</code> to make decisions. The <code>AIPlayer</code>
	...
	/**
	 * Adjusts the score of this proposed mission for this player type. Subclasses
	 * should override and refine this.
	 *
	 * @param aiUnit
	 ...
	 * @param settlement
	 *            The <code>Settlement</code> this player owns and which the given
	 *            <code>Unit</code> is trading.
	 * @param goods
	 ...
	 * @param settlement
	 *            The <code>Settlement</code> this player owns and which the given
	 *            <code>Unit</code> if trying to sell goods.
	 * @param goods
	 *            The goods the given <code>Unit</code> is trying to sell.
	 * @param gold
	 *            The suggested price.
	...
	/**
	 * Decides to accept an offer of mercenaries or not. Overridden by the European
	 * player.
	 *
