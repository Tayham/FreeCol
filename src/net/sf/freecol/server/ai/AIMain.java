...
public class AIMain extends FreeColObject implements FreeColGameObjectListener {
	 ...
	 *
	 * Strictly true only for AI players and their units and colonies (not (yet) for
	 * native settlements). However object initialization is not necessarily
	 * complete when we arrive here, which means we can not yet use the Colony or
	 * Unit owner fields. So the actual test implemented here is somewhat sloppy.
	 *
	 * @param fcgo
	...
	/**
	 * Searches for new {@link FreeColGameObject FreeColGameObjects}. An AI-object
	 * is created for each new object.
	 *
	 * @param overwrite
	...
	/**
	 * Gets the <code>AIObject</code> for the given <code>FreeColGameObject</code>.
	 *
	 * @param fcgo
	...
	/**
	 * Checks the integrity of this <code>AIMain</code> by checking if there are any
	 * invalid objects.
	 *
	 * @param fix
	 ...
	 * <code>FreeColGameObject</code>. This method gets called whenever a new object
	 * gets added to the {@link Game}.
	 *
	 * @param id
	 *            The object identifier.
	 * @param fcgo
