...
public class TileImprovementPlan extends ValuedAIObject {
	...
	/**
	 * Creates a new uninitialized <code>TileImprovementPlan</code> from the given
	 * XML-representation.
	 *
	 * @param aiMain
	 *            The main AI-object.
	 ...
	 *            <code>TileImprovementPlan</code> - a higher value signals a higher
	 *            importance.
	 */
	...
	/**
	 * Gets the pioneer who have been assigned to making the improvement described
	 * by this object.
	 *
	...
	/**
	 * Sets the pioneer who have been assigned to making the improvement described
	 * by this object.
	 *
	 * @param pioneer
	 ...
	 *
	 * @return The <code>Tile</code> where {@link #getPioneer pioneer} should make
	 *         the given {@link #getType improvement}.
	 */
	...
	/**
	 * Gets the 'most effective' TileImprovementType allowed for a given tile and
	 * goods type. Useful for AI in deciding the improvements to prioritize.
	 *
	 * @param tile
	...
	/**
	 * Updates this tile improvement plan to the best available for its tile and the
