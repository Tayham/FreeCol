...
public class Cargo {
	...
	public static class CargoPlan {
		 ...
		 * @param destination
		 *            The destination <code>Location</code> to take the transportable
		 *            to, using the transport destination if null.
		 * @param allowFallback
		 *            Allow a fallback plan that does not complete the transport but
		 *            does at least improve matters.
	 ...
	 * @param destination
	 *            The destination <code>Location</code> to take the transportable
	 *            to, defaulting to the transport destination if null.
	 * @param allowFallback
	...
	/**
	 * Make a new cargo with given transportable, carrier and explicit destination
	 * and fallback state.
	 *
	 * @param t
	 *            The <code>TransportableAIObject</code> to transport.
	...
	/**
	 * Is this cargo collectable? That is, is it and the carrier at their collection
	 * points, and in a collectable mode.
	 *
	...
	/**
	 * Is this cargo deliverable? That is, has it arrived at the target on board the
	 * carrier in a deliverable mode.
	 *
	...
	/**
	 * Is this cargo delivered, or otherwise removed? That is, is the cargo not on
	 * board the carrier in a deliverable mode?
	 *
	...
	/**
	 * Should this <code>Cargo</code> be retried after encountering a blockage? For
	 * now, just tries three times.
	 *
	 * FIXME: be smarter.
	 *
	 ...
	 *
	 * TODO: be smarter and break out of the loop if the cargo reaches its delivery
	 * point.
	 *
	 * @param carrier
