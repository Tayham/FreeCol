...
public class ScoutingMission extends Mission {
	...
	/**
	 * The target for this mission. - A tile with an LCR - A native settlement to
	 * talk to the chief of - A player colony to retarget from - An unexplored tile
	 */
	 ...
	 * @param path
	 *            A <code>PathNode</code> to extract a target from, (uses the unit
	 *            location if null).
	...
	/**
	 * Prepare a unit for this mission. Allow even experts to proceed even if not
	 * mounted.
	 *
	 * @param aiUnit
	...
	/**
	 * Is this a valid scouting target because it is a suitable native settlement or
	 * an intermediate colony.
	 *
	 * @param aiUnit
	 *            The <code>AIUnit</code> to test.
	 * @param settlement
