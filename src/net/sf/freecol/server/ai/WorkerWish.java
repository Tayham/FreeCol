...
public class WorkerWish extends Wish {
	 ...
	 * @param value
	 *            The value identifying the importance of this <code>Wish</code>.
	 * @param unitType
	 *            The type of unit needed for releasing this wish completely.
	 * @param expertNeeded
	 *            Determines wether the <code>unitType</code> is required or not.
	 */
	...
	protected void readAttributes(FreeColXMLReader xr) throws XMLStreamException {
		...
		transportable = xr.hasAttribute(TRANSPORTABLE_TAG)
				? xr.makeAIObject(aiMain, TRANSPORTABLE_TAG, AIUnit.class, (AIUnit) null, true)
				: null;
