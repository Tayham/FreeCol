...
public abstract class Wish extends ValuedAIObject {
	...
	/**
	 * The <code>TransportableAIObject</code> which will realize the wish, or null
	 ...
	 * @return The <code>TransportableAIObject</code> which will realize this wish,
	 ...
	 *
	 * @param transportable
	 *            The <code>TransportableAIObject</code> which should realize this
	 *            wish.
	 ...
	 *         transportable} assigned to this <code>Wish</code> will have to reach.
	 */
	...
	/**
	 * Checks the integrity of a <code>Wish</code>. The destination must be neither
	 * null nor disposed, the transportable may be null but must otherwise be
	 * intact.
	 *
	 * @param fix
