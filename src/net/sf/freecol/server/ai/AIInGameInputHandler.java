...
public final class AIInGameInputHandler implements MessageHandler {
	...
	/**
	 * Handles a "chooseFoundingFather"-message. Only meaningful for AIPlayer types
	 * that implement selectFoundingFather.
	 *
	 * @param connection
	 ...
	 * @param element
	 *            The <code>Element</code> to process.
	 * @return The original message with the acceptance state set if querying the
	 *         colony player (result == null), or null if reporting the final result
	 *         to the native player (result != null).
	 */
