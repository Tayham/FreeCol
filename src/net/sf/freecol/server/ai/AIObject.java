...
public abstract class AIObject extends FreeColObject {
	 ...
	 *            The main AI-object.
	 * @param element
	 *            An <code>Element</code> containing an XML-representation of this
	 *            object.
	 */
	...
	/**
	 * Checks if this <code>AIObject</code> is uninitialized. That is: it has been
	 * referenced by another object, but has not yet been updated with
	 * {@link #readFromXML}.
	 *
	...
	/**
	 * Disposes this <code>AIObject</code> by removing the reference to this object
	 * from the enclosing AIMain.
	 */
	public void dispose() {
