...
public class TerrainGenerator {
	 ...
	 * here and this code is called pre-game, so we intentionally skip the logging
	 * here.
	 */
	 ...
	 *            equator: 0 is the mid-section of the map (equator) +/-90 is on the
	 *            bottom/top of the map (poles).
