...
public class ServerColonyTile extends ColonyTile implements ServerModelObject {
	...
	/**
	 * This method is called only when a new turn is beginning. It will reduce the
	 * quantity of the bonus <code>Resource</code> that is on the given tile, if any
	 * and if applicable.
	 *
	 * @param tile
	 ...
	 * @return The <code>Resource</code> if it is exhausted by this call (so it can
