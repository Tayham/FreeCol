...
public abstract class TransactionSession {
	...
	/**
	 * All transaction types must implement a completion action. The last thing they
	 * should do is call this to remove reference to this transaction.
	 *
	 * @param cs
	 *            A <code>ChangeSet</code> to update with changes that occur when
	 ...
	 * @param o2
	 *            Another <code>FreeColGameObject</code> involved in the session.
	 * @return A transaction session key.
	 */
	 ...
	 * involved. This version is needed for sessions where one of the objects may
	 * have already been disposed of while the session is still valid.
	 *
	 * @param type
	 *            The class of session.
	 * @param s1
