...
public class ServerGame extends Game implements ServerModelObject {
	 ...
	 * @param serverPlayers
	 *            Optional extra <code>ServerPlayer</code>s to include (useful when
	 *            a player dies).
	 */
	...
	/**
	 * Makes a trivial server object in this game given a server object tag and an
	 * identifier.
	 *
	 * @param type
	 ...
	 * @return The <code>ServerPlayer</code> that is eliminated if any, or null if
	 *         none found.
	 */
