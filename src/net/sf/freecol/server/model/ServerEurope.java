...
public class ServerEurope extends Europe implements ServerModelObject {
	...
	/**
	 * Generates the initial recruits for this player. Recruits may be determined by
	 * the difficulty level, or generated randomly.
	 *
	 * @param random
	...
	/**
	 * Extract the recruitable at a given slot, and replace it with the given new
	 * recruitable type.
	 *
	 * Note that we shift the old units down, because the AI always recruits from
	 * the lowest slot.
	 *
	 * @param slot
