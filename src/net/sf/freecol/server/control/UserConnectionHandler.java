...
public final class UserConnectionHandler extends FreeColServerHolder implements MessageHandler {
	 ...
	 * @param element
	 *            The <code>Element</code> (root element in a DOM-parsed XML tree)
	 ...
	 * @param element
	 *            The element containing the request.
	 * @return Null on error (such as requesting during end game), an empty list if
	 *         the game is starting, or a list of all the inactive European players.
	 */
