...
public final class FreeColServer {
	...
	public enum GameState {
		STARTING_GAME, IN_GAME, ENDING_GAME
	}
	 ...
	 * extracting it from the saved game. However MapConverter does call this with
	 * an overriding specification.
	 *
	 * @param savegame
	 ...
	 *
	 * @return The <code>UserConnectionHandler</code> that is beeing used when new
	 *         client connect.
	 */
	 ...
	 *
	 * @return The <code>Game</code> which is the main class of the game-model being
	 *         used in this game.
	 */
	 ...
	 *
	 * @param aiMain
	 *            The main AI-object which is responsible for controlling, updating
	 ...
	 *
	 * @return The main AI-object which is responsible for controlling, updating and
	 *         saving the AI objects.
	 */
	 ...
	 *
	 * @return One of: {@link GameState#STARTING_GAME}, {@link GameState#IN_GAME}
	 ...
	 *
	 * @param state
	 *            The new state to be set. One of: {@link GameState#STARTING_GAME},
	 ...
	 * Sends information about this server to the meta-server.
	 *
	 * This is the master routine with private `firstTime' access when called from
	 * the constructors.
	 *
	 * @param firstTime
	...
	/**
	 * Removes this server from the metaserver's list. The information is only sent
	 * if <code>public == true</code>.
	 *
	 * @return True if the MetaServer was updated.
	 */
	 ...
	 * @exception IOException
	 *                If a problem was encountered while trying to open, write or
	 *                close the file.
	 */
	 ...
	 *
	 * When the specification is not supplied, the one found in the saved game will
	 * be used.
	 *
	 * @param file
	...
	public static ServerGame readGame(File file, Specification spec, FreeColServer server) {
		ServerGame g = null;
		try {
			g = readGame(new FreeColSavegameFile(file), spec, server);
	...
	/**
	 * Add option to capture units under repair in a colony. Establish a new unknown
	 * enemy player.
	 *
	 * @param game
	...
	/**
	 * Removes automatically created save games. Call this function to delete the
	 * automatically created save games from a previous game.
	 */
