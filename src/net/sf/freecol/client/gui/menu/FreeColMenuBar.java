...
public abstract class FreeColMenuBar extends JMenuBar {
	...
	/**
	 * Creates a new <code>FreeColMenuBar</code>. This menu bar will include all of
	 * the submenus and items.
	 *
	 * @param f
	 *            The main controller.
	 */
	...
	/**
	 * When a <code>FreeColMenuBar</code> is disabled, it does not show the "in game
	 * options".
	 */
	@Override
