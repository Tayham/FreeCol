...
public class GrayLayer extends Component {
	...
	/**
	 * Executes painting. The method shadows the background image, and paints the
	 * message with icon (if available) and text.
	 *
	 * @param g
	...
	/**
	 * Set the player for which we paint. If the player is already set, then nothing
	 * happens, otherwise a repaint event is sent.
	 *
	 * @param player
