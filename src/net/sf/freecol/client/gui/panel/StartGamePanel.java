...
public final class StartGamePanel extends FreeColPanel {
	...
	/**
	 * Check that the user has not specified degenerate victory conditions that are
	 * automatically true.
	 *
	 ...
	 *
	 * @param senderName
	 *            The name of the player who sent the chat message to the server.
	 * @param message
	 *            The chat message.
	 * @param privateChat
	...
	/**
	 * Refreshes the table that displays the players and the choices that they've
	 * made.
	 */
