...
public final class EndTurnDialog extends FreeColConfirmDialog {
	...
	/**
	 * We need to wrap the Unit class in order to make the JList support keystroke
	 * navigation. JList.getNextMatch uses the toString() method, but the toString()
	 * method of FreeCol objects provides debugging information rather than a
	 * searchable name.
	 */
