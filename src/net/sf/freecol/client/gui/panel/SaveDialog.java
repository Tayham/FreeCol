...
public final class SaveDialog extends FreeColDialog<File> {
	/**
	 * We need a magic cookie to use for the cancel response, as the JFileChooser
	 * does not tolerate setValue(null).
	 */
	...
	public SaveDialog(FreeColClient freeColClient, JFrame frame, File directory, FileFilter[] fileFilters,
		...
		fileChooser.addActionListener((ActionEvent ae) -> setValue(
				(JFileChooser.APPROVE_SELECTION.equals(ae.getActionCommand())) ? fileChooser.getSelectedFile()
						: cancelFile));
