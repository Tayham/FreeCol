...
public final class SelectDestinationDialog extends FreeColDialog<Location> implements ListSelectionListener {
	...
	/**
	 * A container for a destination location, with associated distance and extra
	 * characteristics.
	 */
	private class Destination {
		...
		/**
		 * Collected extra annotations of interest to a unit proposing to visit a
		 * location.
		 *
		 * @param loc
		 ...
		 * @param goodsTypes
		 *            A list of goods types the unit is carrying.
		 * @return A string containing interesting annotations about the visit or an
		 *         empty string if nothing is of interest.
		 */
