...
public final class ImageSelection implements Transferable {
	...
	/**
	 * Get the data that this Transferable represents or null if the data is not of
	 * the given flavor.
	 *
	 * @param flavor
	 *            The flavor that the data should have.
	 * @return The data that this Transferable represents, or null if the data is
	 *         not of the given flavor.
	 */
	@Override
