...
public final class EuropePanel extends PortPanel {
	...
	/**
	 * A panel to hold unit labels that represent units that are going to America or
	 * Europe.
	 */
	...
	/**
	 * A panel that holds UnitLabels that represent Units that are waiting on the
	 * docks in Europe.
	 */
	...
	/**
	 * A panel that holds unit labels that represent naval units that are waiting in
	 * Europe.
	 */
	 ...
	 *
	 * @param unitLabel
	 *            The <code>UnitLabel</code> for the unit that is being selected.
	 */
	@Override
