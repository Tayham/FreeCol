...
public final class MapGeneratorOptionsDialog extends OptionsDialog {
	 ...
	 *
	 * The option UI may not have been created if we just click on the map, because
	 * the text field is under mapGeneratorOptions.import. Hence the null tests
	 * against the OptionUIs.
	 *
	 * @param file
	 ...
	 * @return A <code>JButton</code> if the map is readable, or null on failure.
	 */
