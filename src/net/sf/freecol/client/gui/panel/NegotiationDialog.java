...
public final class NegotiationDialog extends FreeColDialog<DiplomaticTrade> {
	...
	private class GoodsTradeItemPanel extends JPanel implements ActionListener {
		 ...
		 *
		 * @param source
		 *            The <code>Player</code> nominally in possession of the goods (this
		 *            may be totally fictional).
		 * @param allGoods
	...
	private class UnitTradeItemPanel extends JPanel implements ActionListener {
		 ...
		 *
		 * @param source
		 *            The <code>Player</code> nominally in posession of the unit (this
		 *            may be totally fictional).
		 * @param allUnits
	...
	/**
	 * Gets a list of all possible storable goods (one cargo load). Note that these
	 * goods are fictional. They are the goods that *might* be in the other player's
	 * store. Therefore they have a bogus location (i.e. not the actual goods
	 * container).
	 *
	 * @param gl
