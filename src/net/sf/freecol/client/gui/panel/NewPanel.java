...
public final class NewPanel extends FreeColPanel implements ActionListener, ItemListener {
	 ...
	 * specification box just contains this spec, but if null the user chooses from
	 * available specs using the specification box.
	 */
	 ...
	 * Difficulty levels are relative to the rules, so this can be invalidated by a
	...
	/**
	 * Get the specification. Either the one set for this panel, or the one implied
	 * by the currently selected TC.
	 *
