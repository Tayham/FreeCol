...
public final class MapEditorTransformPanel extends FreeColPanel {
	...
	public abstract class MapTransform implements IMapTransform {
		...
		/**
		 * A panel with information about this transformation. This panel is currently
		 * displayed on the {@link InfoPanel} when selected, but might be used elsewhere
		 * as well.
		 *
	...
	/**
	 * Adds, removes or cycles through the available resources for this Tile. Cycles
	 * through the ResourceTypeList and picks the next valid, or removes if end of
	 * list.
	 */
