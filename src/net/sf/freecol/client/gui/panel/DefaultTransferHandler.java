...
public final class DefaultTransferHandler extends TransferHandler {
	 ...
	 * @return True if the given component can import a selection of the flavor that
	 *         is indicated by the second parameter.
	 */
	@Override
	...
	/**
	 * Creates a Transferable (an ImageSelection to be precise) of the data that is
	 * represented by the given component and returns that object.
	 *
	 * @param comp
	...
	public boolean importData(JComponent comp, Transferable t) {
		try {
			...
			if (comp instanceof UnitLabel) {
				 ...
				 *
				 * If not, assume that the user wished to drop the unit/cargo on the panel
				 * below.
				 */
	...
	/**
	 * Displays an input dialog box where the user should specify a goods transfer
	 * amount.
	 */
