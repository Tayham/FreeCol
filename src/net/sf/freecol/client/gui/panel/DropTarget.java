...
public interface DropTarget {
	 ...
	 * the component represents gets modified so that it is on board the currently
	 * selected carrier.
	 *
	 * @param comp
	 *            The component to add to this container.
	 * @param editState
	 *            Must be set to 'true' if the state of the component that is added
	 *            (which should be a dropped component representing a unit or goods)
	 *            should be changed so that the underlying unit or goods are on
