...
public class FreeColDialog<T> extends JDialog implements PropertyChangeListener {
	 ...
	 *
	 * Much of this was extracted from the source for JOptionPane.createDialog. We
	 * needed a way to control modality.
	 *
	 * @param freeColClient
	 *            The <code>FreeColClient</code> for the game.
	 * @param frame
	...
	/**
	 * Collect the enabled options and return as an array so as to be able to pass
	 * to the JOptionPane constructor.
	 *
	...
	/**
	 * Complete the initialization. Useful for subclasses that need to construct a
	 * non-trivial object to display in the JOptionPane.
	 *
	 * @param frame
	 *            The owner frame.
	 * @param type
	...
	/**
	 * Get the response that was set by {@link JOptionPane#setValue} and clean up
	 * the dialog. Used by implementors of getResponse().
	 *
