...
public final class Utility {
	 ...
	 * dependent on the message source. TODO: Are there more useful possibilities?
	 *
	 * @param key
	 ...
	 * @return A <code>JButton</code> for the link, or null if no good choice found.
	 */
	...
	/**
	 * Gets a text area with standard settings suitable for use in FreeCol panels,
	 * which adapt their size based on what they contain.
	 *
	 * @param text
	 *            The text to display in the text area.
	 * @param columns
	...
	/**
	 * Gets a text area with standard settings suitable for use in FreeCol panels,
	 * which can not adapt their size.
	 *
	 * @param text
	 *            The text to display in the text area.
	 * @param size
	...
	/**
	 * Get a titled border with Messages.message(key) as text and a given colored
	 * line border.
	 *
	 * @param key
	 *            The key to use.
