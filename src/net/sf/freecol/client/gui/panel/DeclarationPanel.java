...
public final class DeclarationPanel extends FreeColPanel {
	...
	private class SignaturePanel extends JPanel {
		 ...
		 * @return The abbreviated version of the given name. The name is made small
		 ...
		 * @return <code>true</code> if the given string was to large to be fully
		 *         displayed.
		 */
		...
		/**
		 * Adds an <code>ActionListener</code> to this <code>SignaturePanel</code>. An
		 * event gets fired when the animation is stopped.
		 * 
		 * @param al
		...
		/**
		 * Starts the animation of the signature. An <code>ActionEvent</code> gets sent
		 * to the registered listeners when the animation has stopped.
		 * 
