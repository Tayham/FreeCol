...
public class ActionManager extends OptionGroup {
	...
	/**
	 * This method adds all FreeColActions to the OptionGroup. If you implement a
	 * new <code>FreeColAction</code>, then you need to add it in this method.
	 * Localization and a possible accelerator need to be added to the strings file.
	 *
