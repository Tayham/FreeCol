...
public final class FileOptionUI extends OptionUI<FileOption> {
	...
	public FileOptionUI(final GUI gui, final FileOption option, boolean editable) {
		...
		/*
		 * fileField.getDocument().addDocumentListener(new DocumentListener() { public
		 * void changedUpdate(DocumentEvent arg0) { editUpdate(); } public void
		 * insertUpdate(DocumentEvent arg0) { editUpdate(); } public void
