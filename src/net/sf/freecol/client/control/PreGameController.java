...
public final class PreGameController {
	...
	/**
	 * Requests the game to be started. This will only be successful if all players
	 ...
	 * Starts the game.
	 *
	 * @return True if the player should continue, false if we are in a debug run
	 *         and should be skipping turns.
	 */
	...
	/**
	 * Update the {@link GameOptions} at the server. This method should be called
	 * after updating that object.
	 */
	...
	/**
	 * Update the {@link MapGeneratorOptions} at the server. This method should be
