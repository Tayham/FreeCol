...
public final class MapEditorController {
	...
	/**
	 * The transform that should be applied to a <code>Tile</code> that is clicked
	 * on the map.
	 */
	 ...
	 *
	 * FIXME: The TC and difficulty level can now be set at the command line, but we
	 * should do better.
	 */
	 ...
	 * 
	 * @param mt
	 *            The transform that should be applied to a <code>Tile</code> that
	 ...
	 * 
	 * @return The transform that should be applied to a <code>Tile</code> that is
	 *         clicked on the map.
	 */
	...
	/**
	 * Transforms the given <code>Tile</code> using the {@link #getMapTransform()
	 * current <code>MapTransform</code>}.
	 *
	 * @param t
